  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{ url('/login') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" id="txtPass" name="txtPass" class="form-control" placeholder="Kata laluan">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary save-btn btn-block">Log Masuk</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <p class="mb-1">
        <a href="{{ url('/forgotPass') }}">Terlupa kata laluan</a>
      </p>
      <p class="mb-0">
      <a href="{{ url('/signUp') }}" class="text-center">Daftar akaun baru</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
