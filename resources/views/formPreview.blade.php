...
<table class="table table-bordered table-sm w-auto" onchange="calculateSectAmount2(this.value2)" required >
  ...
  <table class="table table-bordered table-responsive-md" id="tbl1">
    ...
    <tbody>
      ...
      <tr class="item" onchange="calculateAmount1(this.value)" required >
        ...
        <td><input type="text" class="text-center" id="inputPosition" name="inputPosition[]" value="{{ $tmp['inputPosition'] ?? '' }}" readonly="readonly"></td>
        <td>
          <select class="form-control" id="degree" name="degree[]" disabled>
          <option @if (1 == ($previewData['sect5']['degree'] ?? '')) selected @endif value="1" >Degree/Master/PhD</option>
          <option @if (2 == ($previewData['sect5']['degree'] ?? '')) selected @endif value="2" >Advance Dip/Diploma</option>
          <option @if (3 == ($previewData['sect5']['degree'] ?? '')) selected @endif value="3" >Certificate (SKM3 or equivalent)</option>
          <option @if (4 == ($previewData['sect5']['degree'] ?? '')) selected @endif value="4" >School Leavers</option>
        </select>
        </td>
        <td><input type="number" min=0 oninput="validity.valid||(value='');" step="0.01" 
          class="text-center" id="inputSalary" name="inputSalary[]" value="{{ $tmp['inputSalary'] ?? '' }}" readonly="readonly"></td>
        <td><input type="number" min=0 oninput="validity.valid||(value='');" 
          class="text-center" id="inputPax" name="inputPax[]" value="{{ $tmp['inputPax'] ?? '' }}" readonly="readonly"></td>
        <td><input type="number" class=" text-center boldformula" id="funding" name="funding" readonly="readonly"></td>
      </tr>
      @endforeach
      @else
      <tr class="item" onchange="calculateAmount1(this.value)" required >
        ...
        <td>
          <select class="form-control" id="degree" name="degree[]" disabled>
          <option @if (1 == ($previewData['sect5']['tbl1'][0]['degree'] ?? '')) selected @endif value="1" >Degree/Master/PhD</option>
          <option @if (2 == ($previewData['sect5']['tbl1'][0]['degree'] ?? '')) selected @endif value="2" >Advance Dip/Diploma</option>
          <option @if (3 == ($previewData['sect5']['tbl1'][0]['degree'] ?? '')) selected @endif value="3" >Certificate (SKM3 or equivalent)</option>
          <option @if (4 == ($previewData['sect5']['tbl1'][0]['degree'] ?? '')) selected @endif value="4" >School Leavers</option>
        </select>
        </td>
        <td><input type="number" min=0 oninput="validity.valid||(value='');" step="0.01" 
    ...
    <tfoot>
      <tr>
        ...
        <th><input type="number" class="form-control text-center boldformula" name="totalpax" id="totalpax"  readonly="readonly"></th>
        <th><input type="number" class="form-control text-center boldformula" name="totalfunding" id="totalfunding"  readonly="readonly"></th>
      </tr>
    </tfoot>
  </table>
  ...
  <tbody>
    ...
    <tr class="item2"  onchange="calculateAmount2(this.value)" required >
      ...
      <td colspan="2">
        <input type="number" class="text-center boldformula" name="totalfundingmonth" id="totalfundingmonth"  readonly="readonly"></td>
    </tr>
    @endforeach
    @else
    <tr class="item2"  onchange="calculateAmount2(this.value)" required >
      ...
      <td colspan="2">
        <input type="number" class="text-center boldformula form-control" name="totalfundingmonth" id="totalfundingmonth" style="background-color:#e9ecef" readonly="readonly"></td>
    </tr>
    @endif
  </tbody>
  <tfoot>
