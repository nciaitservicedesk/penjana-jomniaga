    ...
    <tbody>
      ...
      <tr class="item" onchange="calculateAmount1(this.value)" required >
        ...
        <td class="text-center">
          ...
          <input type="number" class="form-control text-center boldformula" id="funding" name="funding" readonly="readonly">
      ...
      <tr class="item" onchange="calculateAmount1(this.value)" required >
        ...
        <td class="text-center">
          <label id="lbFormula" name="lbFormula[]"></label>
          <input type="number" class="form-control text-center boldformula" id="funding" name="funding" style="background-color:#e9ecef" readonly="readonly"></td>
      </tr>
      @endif
    </tbody>
    <tfoot>
